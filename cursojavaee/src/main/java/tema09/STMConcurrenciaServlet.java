...
@WebServlet(name="STMConcurrenciaServlet", urlPatterns={"/STMConcurrenciaServlet"})
public class STMConcurrenciaServlet extends HttpServlet implements SingleThreadModel  {
